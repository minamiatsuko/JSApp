document.querySelector("#myPdf02").addEventListener("change", function(e){
...
pdfjsLib.GlobalWorkerOptions.workerSrc = 'https://mozilla.github.io/pdf.js/build/pdf.worker.js';$("#myPdf02").on("change", function(e){
